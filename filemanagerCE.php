...
register_plugin(
	$thisfile, 		//Plugin id
	'File Manager CE', //Plugin name
	'1.0', 			//Plugin version
	'CE Team ',  	//Plugin author
	'https://getsimple-ce.ovh/donate', //author website
	'Upload, edit, and manage your files and folders directly, without the need for ftp.', //Plugin description
	'files', 		//page type - on which admin tab to display
	'ffm'  			//main function (administration)
);

add_action('files-sidebar', 'createSideMenu', array($thisfile, 'File Manager CE'));

function ffm(){
	global $SITEURL;

	echo '
		<iframe width="100%" height="650px" style="border:none" id="myIframe" src="'. $SITEURL . 'plugins/filemanagerCE/tinyfilemanager.php"></iframe>
